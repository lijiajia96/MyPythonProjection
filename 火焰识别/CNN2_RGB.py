...
data_dir =r"C:\Users\miaojia.li\Documents\WeChat Files\lijia1000\FileStorage\File\2020-02\fire_dataset\wuchuli"
...
loader = creattrain_testds_RGB.fetch_dataloaders(data_dir, [0.8, 0.01, 0.2], batchsize=16)
...
#a=correct_rate(net,loader['test'])
...
for epoch in range(epochs):
    ...
    for i, data in enumerate(loader['train']):
        ...
        if i % 10 == 9:  # 每20个batch打印一次训练状态
            ...
            running_loss = 0.0
    if epoch% 500 == 499:
        torch.save(net, 'D:/zhaopro/fire/modelresnet_fullsize_rgb.pkl')
...
torch.save(net, 'D:/zhaopro/fire/modelresnet_fullsize_rgb.pkl')
correct = correct_rate(net, loader['test'])
